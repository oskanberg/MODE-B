 ...
 * @generated
 */
public class MediaCollectionHostReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MediaCollectionHostReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return MediaLibrary.diagram.edit.policies.MediaLibraryBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistMediaCollectionHost_4001(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setHost(null);
		getNewSource().setHost(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setHost(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
