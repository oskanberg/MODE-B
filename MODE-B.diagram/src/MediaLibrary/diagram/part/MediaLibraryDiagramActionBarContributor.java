 ...
 * @generated
 */
public class MediaLibraryDiagramActionBarContributor extends
	...
	protected Class getEditorClass() {
		return MediaLibrary.diagram.part.MediaLibraryDiagramEditor.class;
	}
	...
	public void init(IActionBars bars, IWorkbenchPage page) {
		...
		IAction validateAction = new MediaLibrary.diagram.part.ValidateAction(
				page);
