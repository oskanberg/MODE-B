 ...
 * @generated
 */
public class MediaLibraryDiagramEditorPlugin extends AbstractUIPlugin {
	...
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		factories
				.add(new MediaLibrary.provider.MediaLibraryItemProviderAdapterFactory());
	...
	public void setLinkConstraints(
			MediaLibrary.diagram.edit.policies.MediaLibraryBaseItemSemanticEditPolicy.LinkConstraints lc) {
	...
	public void setElementInitializers(
			MediaLibrary.diagram.providers.ElementInitializers i) {
		this.initializers = i;
	}
