 ...
 * @generated
 */
public class MediaLibraryModelingAssistantProviderOfEbookEditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((MediaLibrary.diagram.edit.parts.EbookEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			MediaLibrary.diagram.edit.parts.EbookEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(MediaLibrary.diagram.edit.parts.EbookEditPart) sourceEditPart,
				targetEditPart);
	}
