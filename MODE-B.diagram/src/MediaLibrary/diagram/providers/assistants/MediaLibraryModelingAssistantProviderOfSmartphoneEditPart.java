 ...
 * @generated
 */
public class MediaLibraryModelingAssistantProviderOfSmartphoneEditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((MediaLibrary.diagram.edit.parts.SmartphoneEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			MediaLibrary.diagram.edit.parts.SmartphoneEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(MediaLibrary.diagram.edit.parts.SmartphoneEditPart) targetEditPart,
				relationshipType);
	}
