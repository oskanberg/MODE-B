 ...
 * @generated
 */
public class MediaLibraryModelingAssistantProviderOfAudioBookEditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((MediaLibrary.diagram.edit.parts.AudioBookEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			MediaLibrary.diagram.edit.parts.AudioBookEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(MediaLibrary.diagram.edit.parts.AudioBookEditPart) sourceEditPart,
				targetEditPart);
	}
