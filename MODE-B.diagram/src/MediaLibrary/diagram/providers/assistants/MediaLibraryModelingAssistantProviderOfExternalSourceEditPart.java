 ...
 * @generated
 */
public class MediaLibraryModelingAssistantProviderOfExternalSourceEditPart
		extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((MediaLibrary.diagram.edit.parts.ExternalSourceEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			MediaLibrary.diagram.edit.parts.ExternalSourceEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(MediaLibrary.diagram.edit.parts.ExternalSourceEditPart) targetEditPart,
				relationshipType);
	}
