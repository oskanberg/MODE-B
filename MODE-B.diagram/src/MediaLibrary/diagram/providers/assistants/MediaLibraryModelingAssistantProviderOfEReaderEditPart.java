 ...
 * @generated
 */
public class MediaLibraryModelingAssistantProviderOfEReaderEditPart extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((MediaLibrary.diagram.edit.parts.EReaderEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			MediaLibrary.diagram.edit.parts.EReaderEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(MediaLibrary.diagram.edit.parts.EReaderEditPart) targetEditPart,
				relationshipType);
	}
