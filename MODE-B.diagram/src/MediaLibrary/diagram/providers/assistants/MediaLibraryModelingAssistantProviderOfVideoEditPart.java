 ...
 * @generated
 */
public class MediaLibraryModelingAssistantProviderOfVideoEditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((MediaLibrary.diagram.edit.parts.VideoEditPart) sourceEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnSource(
			MediaLibrary.diagram.edit.parts.VideoEditPart source) {
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(MediaLibrary.diagram.edit.parts.VideoEditPart) sourceEditPart,
				targetEditPart);
	}
