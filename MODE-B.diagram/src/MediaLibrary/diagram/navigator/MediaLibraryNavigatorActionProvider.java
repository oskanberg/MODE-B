 ...
 * @generated
 */
public class MediaLibraryNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					MediaLibrary.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof MediaLibrary.diagram.navigator.MediaLibraryNavigatorItem) {
					selectedElement = ((MediaLibrary.diagram.navigator.MediaLibraryNavigatorItem) selectedElement)
							.getView();
