 ...
 * @generated
 */
public class MediaLibraryDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public MediaLibraryDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof MediaLibrary.diagram.navigator.MediaLibraryDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((MediaLibrary.diagram.navigator.MediaLibraryDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new MediaLibrary.diagram.navigator.MediaLibraryDomainNavigatorItem(
