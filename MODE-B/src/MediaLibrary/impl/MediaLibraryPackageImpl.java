...
public class MediaLibraryPackageImpl extends EPackageImpl implements MediaLibraryPackage {
	 ...
	 * @generated
	 */
	public EAttribute getMediaCollection_Name() {
		return (EAttribute)mediaCollectionEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getMediaCollection_SyncedDevices() {
		return (EReference)mediaCollectionEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMediaSource_Name() {
		return (EAttribute)mediaSourceEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getMediaSource_Contents() {
		return (EReference)mediaSourceEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(mediaCollectionEClass, MEDIA_COLLECTION__NAME);
		...
		createEAttribute(mediaSourceEClass, MEDIA_SOURCE__NAME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMediaCollection_Name(), ecorePackage.getEString(), "name", null, 0, 1, MediaCollection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMediaSource_Name(), ecorePackage.getEString(), "name", null, 0, 1, MediaSource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
