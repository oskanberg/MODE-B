 ...
 * <ul>
 *   <li>{@link MediaLibrary.impl.MediaSourceImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public abstract class MediaSourceImpl extends EObjectImpl implements MediaSource {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MediaLibraryPackage.MEDIA_SOURCE__NAME, oldName, name));
	}
