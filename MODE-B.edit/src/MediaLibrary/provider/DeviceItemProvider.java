...
/**
 * This is the item provider adapter for a {@link MediaLibrary.Device} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeviceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHostOfPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediaLibraryPackage.Literals.DEVICE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Host Of feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHostOfPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_hostOf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_hostOf_feature", "_UI_Device_type"),
				 MediaLibraryPackage.Literals.DEVICE__HOST_OF,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCollectionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Device_collections_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Device_collections_feature", "_UI_Device_type"),
				 MediaLibraryPackage.Literals.DEVICE__COLLECTIONS,
				 true,
				 false,
				 true,
				 null,
