...
/**
 * This is the item provider adapter for a {@link MediaLibrary.Artifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MediaLibraryPackage.Literals.ARTIFACT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addOriginPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artifact_origin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artifact_origin_feature", "_UI_Artifact_type"),
				 MediaLibraryPackage.Literals.ARTIFACT__ORIGIN,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Artifact.class)) {
			case MediaLibraryPackage.ARTIFACT__NAME:
